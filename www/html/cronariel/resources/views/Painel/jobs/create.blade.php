                            ...
                            <form class="form-horizontal" method="post" action="{{ route('jobs.store') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="minuto" name="minuto"
                                                   placeholder="Minuto">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="dia_mes" name="dia_mes"
                                                   placeholder="Dia">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="comando" name="comando"
                                                   placeholder="Comando que será realizado...">
                                        </div>
                                    </div>
